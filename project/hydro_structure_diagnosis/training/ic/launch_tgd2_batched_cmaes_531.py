...
from training.ic.run_tgd2_batched_cmaes_531 import DEFAULT_GENERATIONS, DEFAULT_STARTS, MODEL_DIMENSIONS, population_for_dimension
...
def main() -> None:
    ...
    if min(args.starts, args.generations, args.chunk_basins, args.checkpoint_interval) < 1:
        parser.error("starts, generations, chunk-basins, and checkpoint-interval must be positive")
    ...
    for model in args.models:
        ...
        command = [
            ...
            "--generations", str(args.generations), "--chunk-basins", str(args.chunk_basins),
