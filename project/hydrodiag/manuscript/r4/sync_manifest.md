...
机器可读版本：`manuscript/r4/sync_manifest.json`（含全部期望 sha256）
...
4. **R1/R2 统计表**（`results/R1`、`results/R2`、`manuscript/results/R1`）：原机计算，本节点没有；同步 1–5 后用 `manuscript/scripts/r1/build_r1_statistics.py` 重建。
