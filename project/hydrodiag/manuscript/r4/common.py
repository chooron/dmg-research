...
# manuscript/r4/ -> project/hydrodiag: parents[2] is the hydrodiag project root.
...
# ---------------------------------------------------------------------------
# R1/R2 canonical periods (frozen; identical to manuscript/scripts/r1/r1_daily_inference.py)
# ---------------------------------------------------------------------------
