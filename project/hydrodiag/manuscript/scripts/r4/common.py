...
# manuscript/scripts/r4 -> project/hydrodiag: parents[3] is the project root.
PROJECT_ROOT = Path(__file__).resolve().parents[3]
WORKSPACE_ROOT = Path(__file__).resolve().parents[5]

# Worktree-local defaults are intentional: manuscript generation must not
# silently read or write a sibling checkout. Use R4_RESULTS_ROOT only when
