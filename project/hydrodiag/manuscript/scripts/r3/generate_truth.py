...
1. fit ``theta* = g*(A)`` on the full 35-dimension attribute vector
   (``r3/truth_generator.py``) anchored on the 531-basin XAJ-CN IC field;
...
from manuscript.scripts.r3.truth_generator import build_and_save_truth, load_cn_ic_field  # noqa: E402
...
def load_bundle(project_root: Path, data_root: Path):
    from manuscript.scripts.r3.common import load_bundle as _load
