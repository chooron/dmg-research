...
python r3/generate_truth.py --device cuda

# Phase 3 — Base-no-refit
python r3/run_base_no_refit.py --device cuda

# Phase 4/5 — pilot gate (engineering only; --dry-run to preview commands)
python r3/pilot.py --stage cn-ic --dry-run
python r3/pilot.py --stage all --device cuda

# gate outputs
python r3/analyze_pilot.py --device cuda
```
...
(documented by `r3/oracle_identity.py`; e.g. up to ~1.3 mm/day discharge
