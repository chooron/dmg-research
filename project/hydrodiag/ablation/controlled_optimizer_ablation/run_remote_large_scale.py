...
def run_large_scale_ablation():
    ...
    generations = 200
    stdev_init = 0.25
    max_concurrent_groups = 6 # BUMPED TO 6 CONCURRENT GPU WORKER GROUPS FOR OPTIMAL CONCURRENCY & SAFETY!
    ...
    for m_cfg in model_configs:
        ...
        print(f"  Model {m_key:<10}: {len(tasks)} tasks generated across populations {pops}")
