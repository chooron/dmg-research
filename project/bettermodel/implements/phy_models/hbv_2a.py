...
class Hbv_2a(torch.nn.Module):
    ...
    def forward(
        ...
        # Unpack parameters.
        phy_dy_params, phy_static_params, routing_params = (
            parameters[0],
            parameters[1],
            parameters[2],
        )
    ...
    def PBM(
        ...
        if torch.isnan(Qsimmu).any():
            print("NaN detected in physical model output BEFORE weighting!")
