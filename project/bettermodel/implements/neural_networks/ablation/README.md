...
This folder contains the six minimal component-wise variants requested for the
S5D reviewer response. The variants only switch three components in the dynamic
parameter network:
...
`project/bettermodel/conf/config_dhbv_s5d_ablation_base.yaml`. The six runnable
variant configs are:
