...
CONFIG=${CONFIG:-${PROJECT_DIR}/conf/config_dhbv_transformer.yaml}
...
for SEED in ${SEEDS}; do
    ...
    labels+=("seed=${SEED}")
    echo "bettermodel multiseed | model=transformer | mode=${MODE} | seed=${SEED} | test_epoch=${TEST_EPOCH} | gpu_id=${GPU_ID}"
