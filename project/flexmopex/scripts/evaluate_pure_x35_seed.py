#!/usr/bin/env python3
"""Evaluate Pure-Attribute Structure Encoder variant for a given seed."""
...
def evaluate(seed: int, cfg_path: str, out_root: Path, run_name: str, dev: str = "cuda:0"):
    ...
    print(f"Pure x35 Seed {seed} (Ep10): Median NSE={median_nse:.4f} | Mean NSE={mean_nse:.4f} | >0: {frac_pos:.3f} | >0.5: {frac_05:.3f}")
    ...
    for proc in PROCESSES:
        ...
        d = process_eval[proc]
        print(f"  [{proc}] n_pos={d['n_oracle_pos']} | mean={d['mean']:.4f} | std={d['std']:.4f} (range [{d['min']:.3f}, {d['max']:.3f}]) | "
...
if __name__ == "__main__":
    ...
    cfg_map = {
        42: ("conf/config_dmopex_interceptE_S0_r19_pure_x35_seed42.yaml",
             Path("results/pure_x35_r19/seed_42"), "seed_42"),
        43: ("conf/config_dmopex_interceptE_S0_r19_pure_x35_seed43.yaml",
             Path("results/pure_x35_r19/seed_43"), "seed_43"),
        44: ("conf/config_dmopex_interceptE_S0_r19_pure_x35_seed44.yaml",
             Path("results/pure_x35_r19/seed_44"), "seed_44"),
    }
