#!/bin/bash
# Launch extra alpha runs with max 2 parallel using setsid for detached processes.
# This script launches all jobs and exits immediately. Jobs run in background.
...
wait
log "All extra alpha runs complete."
