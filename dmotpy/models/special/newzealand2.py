...
# 引入通量计算函数
from dmot.models.flux.evap import evap_1, evap_6, evap_5
from dmot.models.flux.interception import interception_1
from dmot.models.flux.saturation import saturation_1
from dmot.models.flux.interflow import interflow_9
from dmot.models.flux.baseflow import baseflow_1

# 引入单位线: uh_4_full (Full Triangular)
from dmot.models.unithydro.uh_tri_4 import DplTri4
...
class Newzealand2(HydrologyModel):
    """
        ...
        with torch.no_grad():
            for t in range(warm_up):
                _, _, S1, S2 = self.production_step(
                    P_seq[t], PET_seq[t], S1, S2, s1max, s2max, sfc_frac, m, a, b, tcbf, nearzero
                )
