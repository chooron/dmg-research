...
from dmot.models.flux.evap import evap_12
from dmot.models.flux.saturation import saturation_5
from dmot.models.flux.split import split_1
from dmot.models.unithydro.uh_exp_5 import DplExp5
from dmot.models.unithydro.uh_delay_8 import DplDelay8
...
class Ihacres(HydrologyModel):
    ...
    def _run_model(
        ...
        for t in range(n_steps):
            flux_uq, flux_us, _, S1 = self.production_step(P_seq[t], PET_seq[t], S1, lp, d, p, alpha, nearzero)
