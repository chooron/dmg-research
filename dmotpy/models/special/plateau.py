...
# 引入通量计算函数
from dmot.models.flux.interception import interception_2
from dmot.models.flux.infiltration import infiltration_4
from dmot.models.flux.evap import evap_4
from dmot.models.flux.capillary import capillary_2
from dmot.models.flux.saturation import saturation_1
...
class Plateau(HydrologyModel):
    ...
    def _run_model(
        ...
        with torch.no_grad():
            for t in range(warm_up):
                _, _, _, S1, S2 = self.production_step(
                    P_seq[t], PET_seq[t], S1, S2, fmax, dp, sumax, lp, p_coeff, c_rise, kp, nearzero
                )
        ...
        routed_pie = routed_pie_flat.view(n_grid, nmul, n_steps).permute(2, 0, 1)
