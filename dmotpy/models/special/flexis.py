...
# 引入通量计算函数
from dmot.models.flux.snowfall import snowfall_1
from dmot.models.flux.rainfall import rainfall_1
from dmot.models.flux.melt import melt_1
from dmot.models.flux.evap import evap_1, evap_3
from dmot.models.flux.saturation import saturation_3
from dmot.models.flux.percolation import percolation_2
from dmot.models.flux.split import split_1
from dmot.models.flux.baseflow import baseflow_1

# 引入单位线 (使用三角形单位线，与 Flex-I 保持一致)
from dmot.models.unithydro.uh_tri_3 import DplTri3
    ...
    def _run_model(
        ...
        for t in range(n_steps):
            flux_rf, flux_rs_total, _, S1, S2, S3 = self.production_step(
                P_seq[t], T_seq[t], PET_seq[t], S1, S2, S3, smax, beta, d_split, percmax, lp, imax, tt, ddf, nearzero
            )
